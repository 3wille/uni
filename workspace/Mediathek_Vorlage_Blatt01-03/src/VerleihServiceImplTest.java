...
public class VerleihServiceImplTest
{
    ...
    /**
     * prüft ob verleihkarten erstellt und gespeichert werden 
     */
    @Test
    public void waspassiertmitneuerVerleihkarte()
    {
    	Datum d = new Datum(3,4,14);
    	_verleihService.verleiheAn(_brian, _uschi, d);
    	assertTrue(_verleihService.getVerleihkarteFuer(_abbey)!=null);
