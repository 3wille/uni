...
import services.KundenstammService;
import services.MedienbestandService;
import services.ProtokollierException;
import services.ServiceObserver;
import services.SubWerkzeugObserver;
import services.VerleihService;
import materialien.Kunde;
import materialien.medien.Medium;
...
class AusleihWerkzeug
{
    ...
    private void leiheAusgewaehlteMedienAus()
    {
        ...
        try {
			...
			JOptionPane.showMessageDialog(null, "Datei nicht gefunden","Fehlermeldung",JOptionPane.ERROR_MESSAGE);
		}
    }
