        ...
        VerleihService
{
    ...
    /**
     * das Protokoll über alle Vorgänge
     */
    private VerleihProtokollierer _proto;
            ...
            List<Verleihkarte> initialBestand)
    {
        ...
        _proto = new VerleihProtokollierer();
    }
    ...
    public void nimmZurueck(List<Medium> medien, Datum rueckgabeDatum) throws ProtokollierException
    {
        ...
        for (Medium medium : medien)
        {
            ...
            _proto.protokolliere("wird zurückgegeben", getVerleihkarteFuer(medium));
        }
    ...
    public void verleiheAn(Kunde kunde, List<Medium> medien, Datum ausleihDatum) throws ProtokollierException
    {
        ...
        for (Medium medium : medien)
        {
            ...
            _proto.protokolliere("wird ausgeliehen", verleihkarte);
        }
