        ...
        VerleihService
{
    ...
    public void nimmZurueck(List<Medium> medien, Datum rueckgabeDatum)
    {
    	...
    	assert rueckgabeDatum != null : "Vorbedingung verletzt: lokalVar != null"; 
    ...
    {
    	assert kundeImBestand(kunde) : "Vorbedingung verletzt:  kundeImBestand()";
    	assert medienImBestand(medien) : "Vorbedingung verletzt:  mediumImBestand()"; 
    ...
    {
    	assert kunde != null : "Vorbedingung verletzt: lokalVar != null"; 
    ...
    {
    	assert medien != null : "Vorbedingung verletzt: lokalVar != null"; 
